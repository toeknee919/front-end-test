...
//creates a button to search from n to n+25 to add results to the page
...
// adds more results to the page (n contains the number of results the page will now contain)
